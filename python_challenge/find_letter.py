...
x = re.findall("[a-z][A-Z]{3}[a-z][A-Z]{3}[a-z]", data)
print(x)

def remove_small_letters(a):
    return [*map(lambda e: e[1:-1:], a)]

res_no_letters = remove_small_letters(x)

result_string = "".join(res_no_letters)

print(result_string)

res_list = [c for c in result_string if c in ascii_lowercase]
res_str = "".join(res_list)

print(f"result is: { res_str }")